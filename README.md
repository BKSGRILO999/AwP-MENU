...
local Window = OrionLib:MakeWindow({Name = "AwP MENU", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "AwP MENU"})
...
W:AddLabel("[+] AwP MENU Injection!")
W:AddLabel("[+] Good AutoFarm!")
